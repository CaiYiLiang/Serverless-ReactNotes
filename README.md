...
- Low maintenance <br> You don't need to worried about server maintance(Such as the issues I met in my previous company: hight cpu, disk storage and perfoemance), as you push the code to third-party platforms and run there.
- Low cost <br> You will be charged when there is request.
- Easy to scale <br>
...
### Where I got stuck
 ...
 - Internal Server Error / 403(Forbidden) / 401(Unauthorized)<br>
