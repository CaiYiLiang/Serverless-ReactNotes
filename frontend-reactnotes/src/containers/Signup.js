...
// Signup with AWS Cognito service
// Verfiy through mail(define on AWS Cognito page)
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <FormGroup controlId="confirmPassword" bsSize="large">
          ...
          <ControlLabel className="passwordReminder">Password: Require numbers,special characters,uppercase letters,lowercase letters </ControlLabel>
        </FormGroup>
        <LoaderButton
          block
          bsSize="large"
